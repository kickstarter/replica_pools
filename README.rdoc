...
The Default SlavePool will be used for all requests, so you should name one of the pools 'default' (if there isn't a 'default' slave_pool, the first slave_pool specified becomes the default)
